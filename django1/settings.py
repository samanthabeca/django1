...
SECRET_KEY = 'django-insecure-8mrczp*+!r=^6i1z%*krz5+wh_hfy*xqs(r6x+o27gf$(@qy&5'
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #acrescentado manualmente após a instalação do whitenoise e gunicorn
